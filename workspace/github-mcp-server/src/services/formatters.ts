...
export function formatRepositoryList(repos: GitHubRepository[], total?: number): string {
  const lines = [
...
export function formatIssueList(issues: GitHubIssue[], total?: number): string {
  const lines = [
...
export function formatPullRequestList(prs: GitHubPullRequest[], total?: number): string {
  const lines = [
...
export function formatCommit(commit: GitHubCommit): string {
  const lines = [
...
export function formatCommitList(commits: GitHubCommit[]): string {
  const lines = [
    `# Commits`,
    ""
  ];
