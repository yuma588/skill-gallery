...
(async () => {
  try {
    console.log('开始爬取 init_skill.py 文件...');
    console.log('URL: https://github.com/anthropics/skills/blob/main/skills/skill-creator/scripts/init_skill.py');
    console.log('\n' + '='.repeat(60));
    ...
    const filePath = 'd:/frontend-design/init_skill.py';
