...
(async () => {
  try {
    console.log('开始爬取 workflows.md 文件...');
    console.log('URL: https://github.com/anthropics/skills/blob/main/skills/skill-creator/references/workflows.md');
    console.log('\n' + '='.repeat(60));
    ...
    const filePath = 'd:/frontend-design/workflows.md';
